class Character extends MovableObject{
    ...
    IMAGES_JUMPING = ['img/wizard/jump/jump_000.png',
  ...
  walking_sound = new Audio('audio/walking.mp3');  
    ...
    animate(){ // laufende Animation
       setInterval(() => {
        ...
        if(this.world.keyboard.SPACE && !this.isAboveGround()) { // wenn der character nicht über dem Boden ist, kann er springen
          this.jump();
        }
